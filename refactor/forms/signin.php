...
// Remove sign in button, present sign up form.
  echo <<<_END
    <script>
      $("#signInBtn").remove();
    </script>
    <form class='form-signin' method='post' action='signin.php'>
      <div class='main'><h3>Please enter your details to sign in</h3>
        <input type='text' maxlength='16' name='user' value='$user' placeholder='Username' required autofocus><br>
        <input type='password' maxlength='16' name='pass' value='$pass' placeholder='Password' required><br>
        $error<br>
