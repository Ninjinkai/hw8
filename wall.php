...
echo <<<_END
                <p class="navbar-text">$user
                    ...
                    <a class="btn btn-lg btn-primary navbar-btn" href="index.php" role="button">Post pic</a>
                </p>
_END;
                }
                else
...
echo <<<_END
                <p class="navbar-text">Not signed in
                    <a class="btn btn-lg btn-primary navbar-btn" href="forms/index.php" role="button">Post pic</a>
                </p>
_END;
                }
?>
